...
static NSString *const kACPLocalNotificationDomain = @"nu.mine.powerfamilyau.MyStopMonitorV1.1";
...
- (void)changeNotificationTimePeriod:(NSInteger)lastNotification {
    ...
    //ACPLog(@"Notification time period has changed from %ld to %ld", (long)lastNotification, (long)newNotification);
